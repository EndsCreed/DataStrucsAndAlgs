...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < names.length; i++) {
            scores[i] = randInt.nextInt(0, 1000);
        ...
        for (int i = 0; i < n; i++) {
            ...
            System.out.print("\rQuickSort Progress: " + ((double) i/(double) n)*100 + "%");
        ...
        for (int i = 0; i < n; i++) {
            ...
            long endTime = System.nanoTime();
            System.out.print("\rBubbleSort Progress: " + ((double) i/(double) n)*100 + "%");
        ...
        if (verifySymmetry(namesQuick, scoresQuick)) {
            ...
            double averageTimeBubble = (double) totalTimeBubble / n;
